...
* Expert
  ...
  * Frontend: concept and implementation of user interfaces
    * e.g. WebApps (HTML5/CSS3, Javascript, Frameworks like qooxdoo, Angular), WYSIWYG UI editors, charts, grafics programming)
    * Angular (Angular 2~7) UI Architect
  * Backend: Java, C# (JPA, Hibernate, xSQL, Mongo, Amazon AWS SNS/SQS/S3)
...
* Project Lead
  * Experience as project lead for small-middle scale projects (ca. 6 months)
...
|Cross-Plattform|Phonegap and Phonegap Plugins (for Android), Java, Javascript|
...
|Support|Jira, Mantis, PHProject, BugTracker, Jenkins, Teamcity|
